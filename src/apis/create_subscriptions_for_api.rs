...
/// struct for typed errors of method `block_height_reached`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum BlockHeightReachedError {
...
pub enum NewConfirmedInternalTransactionsForSpecificAmountError {
    ...
    Status409(crate::models::InlineResponse40922),
    Status415(crate::models::InlineResponse415),
    Status422(crate::models::InlineResponse422),
    Status429(crate::models::InlineResponse429),
    Status500(crate::models::InlineResponse500),
...
pub enum NewConfirmedTokenTransactionsForSpecificAmountError {
    ...
    Status409(crate::models::InlineResponse40921),
    Status415(crate::models::InlineResponse415),
    Status422(crate::models::InlineResponse422),
    Status429(crate::models::InlineResponse429),
    Status500(crate::models::InlineResponse500),
...
pub async fn block_height_reached(configuration: &configuration::Configuration, blockchain: &str, network: &str, context: Option<&str>, block_height_reached_rb: Option<crate::models::BlockHeightReachedRb>) -> Result<crate::models::BlockHeightReachedR, Error<BlockHeightReachedError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/blockchain-events/{blockchain}/{network}/subscriptions/block-height-reached", configuration.base_path, blockchain=crate::apis::urlencode(blockchain), network=crate::apis::urlencode(network));
    ...
    local_var_req_builder = local_var_req_builder.json(&block_height_reached_rb);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BlockHeightReachedError> = serde_json::from_str(&local_var_content).ok();
