...
pub async fn get_contract_details_by_address(configuration: &configuration::Configuration, blockchain: &str, network: &str, contract_address: &str, context: Option<&str>) -> Result<crate::models::GetContractDetailsByAddressResponse, Error<GetContractDetailsByAddressError>> {
