...
pub enum GetAddressBalanceError {
    ...
    Status401(crate::models::InlineResponse4011),
    Status402(crate::models::InlineResponse402),
    Status403(crate::models::InlineResponse4031),
    Status409(crate::models::InlineResponse409),
    Status415(crate::models::InlineResponse415),
    Status422(crate::models::InlineResponse422),
    Status429(crate::models::InlineResponse429),
...
pub enum GetTransactionDetailsByTransactionIdError {
    Status400(crate::models::InlineResponse4005),
    Status401(crate::models::InlineResponse4015),
    Status402(crate::models::InlineResponse402),
    Status403(crate::models::InlineResponse4035),
    Status404(crate::models::InlineResponse404),
    Status409(crate::models::InlineResponse409),
    Status415(crate::models::InlineResponse415),
    Status422(crate::models::InlineResponse422),
...
pub async fn get_address_balance(configuration: &configuration::Configuration, blockchain: &str, network: &str, address: &str, context: Option<&str>) -> Result<crate::models::GetAddressBalanceR, Error<GetAddressBalanceError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/blockchain-data/{blockchain}/{network}/addresses/{address}/balance", configuration.base_path, blockchain=crate::apis::urlencode(blockchain), network=crate::apis::urlencode(network), address=crate::apis::urlencode(address));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAddressBalanceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_block_details_by_block_height(configuration: &configuration::Configuration, blockchain: &str, network: &str, height: i64, context: Option<&str>) -> Result<crate::models::GetBlockDetailsByBlockHeightR, Error<GetBlockDetailsByBlockHeightError>> {
...
pub async fn list_confirmed_tokens_transfers_by_address_and_time_range(configuration: &configuration::Configuration, blockchain: &str, network: &str, address: &str, from_timestamp: i32, to_timestamp: i32, context: Option<&str>, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::ListConfirmedTokensTransfersByAddressAndTimeRangeR, Error<ListConfirmedTokensTransfersByAddressAndTimeRangeError>> {
...
pub async fn list_internal_transactions_by_address_and_time_range(configuration: &configuration::Configuration, blockchain: &str, network: &str, address: &str, from_timestamp: i32, to_timestamp: i32, context: Option<&str>, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::ListInternalTransactionsByAddressAndTimeRangeR, Error<ListInternalTransactionsByAddressAndTimeRangeError>> {
