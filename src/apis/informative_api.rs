...
pub async fn list_all_assets_from_all_wallets(configuration: &configuration::Configuration, context: Option<&str>, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::ListAllAssetsFromAllWalletsR, Error<ListAllAssetsFromAllWalletsError>> {
...
pub async fn list_supported_tokens(configuration: &configuration::Configuration, blockchain: &str, network: &str, context: Option<&str>, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::ListSupportedTokensR, Error<ListSupportedTokensError>> {
...
pub async fn list_wallet_transactions(configuration: &configuration::Configuration, blockchain: &str, network: &str, wallet_id: &str, context: Option<&str>, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::ListWalletTransactionsR, Error<ListWalletTransactionsError>> {
