...
pub struct GetBlockDetailsByBlockHashFromCallbackRibs {
...
impl GetBlockDetailsByBlockHashFromCallbackRibs {
    pub fn new(bits: String, chainwork: String, difficulty: String, merkle_root: String, nonce: String, size: i32, stripped_size: i32, version: i32, version_hex: String, weight: i32, strippedsize: i32, extra_data: String, gas_limit: i32, gas_used: i32, mined_in_seconds: i32, sha3_uncles: String, total_difficulty: String, ds_block: i32, ds_difficulty: String, ds_leader: String, micro_blocks: Vec<String>, total_coins: crate::models::GetLatestMinedXrpRippleBlockRiTotalCoins, total_fees: crate::models::GetLatestMinedXrpRippleBlockRiTotalFees, bandwidth_used: String, burned_trx: String, energy_used: String) -> GetBlockDetailsByBlockHashFromCallbackRibs {
