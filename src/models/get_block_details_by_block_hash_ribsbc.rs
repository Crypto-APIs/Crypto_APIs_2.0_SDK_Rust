...
impl GetBlockDetailsByBlockHashRibsbc {
    /// Bitcoin Cash
    pub fn new(difficulty: String, nonce: i32, size: i32, bits: String, chainwork: String, merkleroot: String, version: i32, version_hex: String) -> GetBlockDetailsByBlockHashRibsbc {
