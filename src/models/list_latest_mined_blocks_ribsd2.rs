...
pub struct ListLatestMinedBlocksRibsd2 {
...
impl ListLatestMinedBlocksRibsd2 {
    /// Dogecoin
    pub fn new(bits: String, chainwork: String, difficulty: String, merkle_root: String, nonce: i32, size: i32, stripped_size: i32, version: i32, weight: i32) -> ListLatestMinedBlocksRibsd2 {
