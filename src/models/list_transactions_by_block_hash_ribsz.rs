...
pub struct ListTransactionsByBlockHashRibsz {
...
impl ListTransactionsByBlockHashRibsz {
    /// Zcash
    pub fn new(binding_sig: String, expiry_height: i32, join_split_pub_key: String, join_split_sig: String, locktime: i32, overwintered: bool, size: i32, v_join_split: Vec<crate::models::ListTransactionsByBlockHashRibszVJoinSplit>, v_shielded_output: Vec<crate::models::ListConfirmedTransactionsByAddressRibszVShieldedOutput>, v_shielded_spend: Vec<crate::models::ListConfirmedTransactionsByAddressRibszVShieldedSpend>, value_balance: String, version: i32, version_group_id: String, vin: Vec<crate::models::ListTransactionsByBlockHashRibszVin>, vout: Vec<crate::models::ListConfirmedTransactionsByAddressRibszVout>) -> ListTransactionsByBlockHashRibsz {
