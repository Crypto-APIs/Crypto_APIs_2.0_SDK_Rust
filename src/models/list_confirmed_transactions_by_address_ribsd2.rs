...
impl ListConfirmedTransactionsByAddressRibsd2 {
    /// Dash
    pub fn new(locktime: i64, size: i32, version: i32, vin: Vec<crate::models::ListConfirmedTransactionsByAddressRibsd2Vin>, vout: Vec<crate::models::ListConfirmedTransactionsByAddressRibsd2Vout>) -> ListConfirmedTransactionsByAddressRibsd2 {
