...
pub struct ListTokensForwardingAutomationsRi {
    ...
    pub token_data: Box<crate::models::ListTokensForwardingAutomationsRits>,
}

impl ListTokensForwardingAutomationsRi {
    pub fn new(callback_url: String, created_timestamp: i32, fee_address: String, fee_priority: FeePriority, from_address: String, minimum_transfer_amount: String, reference_id: String, to_address: String, token_data: crate::models::ListTokensForwardingAutomationsRits) -> ListTokensForwardingAutomationsRi {
