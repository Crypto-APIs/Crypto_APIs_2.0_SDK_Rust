...
pub struct NewConfirmedCoinsTransactionsRequestBodyDataItem {
...
impl NewConfirmedCoinsTransactionsRequestBodyDataItem {
    pub fn new(address: String, callback_url: String) -> NewConfirmedCoinsTransactionsRequestBodyDataItem {
