...
pub struct ListCoinsForwardingAutomationsRi {
...
impl ListCoinsForwardingAutomationsRi {
    pub fn new(callback_url: String, confirmations_count_trigger: i32, created_timestamp: i32, fee_priority: FeePriority, from_address: String, minimum_transfer_amount: String, reference_id: String, to_address: String) -> ListCoinsForwardingAutomationsRi {
