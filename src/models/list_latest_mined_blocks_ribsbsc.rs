...
impl ListLatestMinedBlocksRibsbsc {
    /// Binance Smart Chain
    pub fn new(extra_data: String, gas_limit: String, gas_used: String, mined_in_seconds: i32, sha3_uncles: String, total_difficulty: String, uncles: Vec<String>) -> ListLatestMinedBlocksRibsbsc {
