...
pub struct ListAllAssetsFromAllWalletsRi {
    #[serde(rename = "coins")]
...
impl ListAllAssetsFromAllWalletsRi {
    pub fn new(coins: Vec<crate::models::ListAllAssetsFromAllWalletsRiCoins>, fungible_tokens: Vec<crate::models::ListAllAssetsFromAllWalletsRiFungibleTokens>, non_fungible_tokens: Vec<crate::models::ListAllAssetsFromAllWalletsRiNonFungibleTokens>, wallet_id: String, wallet_name: String) -> ListAllAssetsFromAllWalletsRi {
