...
pub struct DecodeRawTransactionHexRislVin {
    ...
    pub script_sig: Box<crate::models::DecodeRawTransactionHexRislScriptSig>,
...
impl DecodeRawTransactionHexRislVin {
    pub fn new(script_sig: crate::models::DecodeRawTransactionHexRislScriptSig) -> DecodeRawTransactionHexRislVin {
