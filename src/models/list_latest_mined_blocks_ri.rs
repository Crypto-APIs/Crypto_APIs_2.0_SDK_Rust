...
pub struct ListLatestMinedBlocksRi {
...
impl ListLatestMinedBlocksRi {
    pub fn new(hash: String, height: i32, previous_block_hash: String, timestamp: i32, transactions_count: i32, blockchain_specific: crate::models::ListLatestMinedBlocksRibs) -> ListLatestMinedBlocksRi {
