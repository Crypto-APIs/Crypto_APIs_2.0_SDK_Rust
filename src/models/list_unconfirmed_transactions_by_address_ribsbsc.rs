...
impl ListUnconfirmedTransactionsByAddressRibsbsc {
    /// Binance Smart Chain
    pub fn new(gas_limit: String, gas_price: crate::models::ListConfirmedTransactionsByAddressRibsbscGasPrice, input_data: String, nonce: i32, transaction_status: String) -> ListUnconfirmedTransactionsByAddressRibsbsc {
