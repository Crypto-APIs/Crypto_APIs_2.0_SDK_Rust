...
pub struct TransactionRequestRejectDataItem {
...
impl TransactionRequestRejectDataItem {
    pub fn new(blockchain: String, network: String, required_approves: i32, required_rejects: i32, current_approves: i32, current_rejects: i32) -> TransactionRequestRejectDataItem {
