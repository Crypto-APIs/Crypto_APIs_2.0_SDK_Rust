...
pub struct ListInternalTransactionsByAddressAndTimeRangeRi {
...
impl ListInternalTransactionsByAddressAndTimeRangeRi {
    pub fn new(amount: String, mined_in_block_hash: String, mined_in_block_height: i32, operation_id: String, operation_type: String, parent_hash: String, recipient: String, sender: String, timestamp: i32) -> ListInternalTransactionsByAddressAndTimeRangeRi {
