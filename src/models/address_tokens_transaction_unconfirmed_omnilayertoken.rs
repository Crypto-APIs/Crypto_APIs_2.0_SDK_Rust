...
pub struct AddressTokensTransactionUnconfirmedOmnilayertoken {
...
impl AddressTokensTransactionUnconfirmedOmnilayertoken {
    /// omniLayerToken
    pub fn new(name: String, property_id: String, transaction_type: String, created_by_transaction_id: String, amount: String) -> AddressTokensTransactionUnconfirmedOmnilayertoken {
