...
pub struct ListConfirmedTransactionsByAddressAndTimeRangeRi {
    ...
    pub blockchain_specific: Box<crate::models::ListConfirmedTransactionsByAddressAndTimeRangeRibs>,
}

impl ListConfirmedTransactionsByAddressAndTimeRangeRi {
    pub fn new(index: i32, recipients: Vec<crate::models::GetTransactionDetailsByTransactionIdriRecipients>, senders: Vec<crate::models::GetTransactionDetailsByTransactionIdriSenders>, timestamp: i32, transaction_hash: String, transaction_id: String, fee: crate::models::ListConfirmedTransactionsByAddressRiFee, blockchain_specific: crate::models::ListConfirmedTransactionsByAddressAndTimeRangeRibs) -> ListConfirmedTransactionsByAddressAndTimeRangeRi {
