...
pub struct ListTransactionsByBlockHeightRibsbsc {
...
impl ListTransactionsByBlockHeightRibsbsc {
    /// Binance Smart Chain
    pub fn new(gas_limit: String, gas_price: crate::models::ListTransactionsByBlockHeightRibsbscGasPrice, gas_used: String, input_data: String, nonce: i32, transaction_status: String) -> ListTransactionsByBlockHeightRibsbsc {
