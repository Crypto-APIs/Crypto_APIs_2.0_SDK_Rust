...
pub struct ListAllUnconfirmedTransactionsRibseFee {
    /// String representation of the fee value
    #[serde(rename = "amount")]
    pub amount: String,
}

impl ListAllUnconfirmedTransactionsRibseFee {
    /// Object representation of the transaction fee
    pub fn new(amount: String) -> ListAllUnconfirmedTransactionsRibseFee {
