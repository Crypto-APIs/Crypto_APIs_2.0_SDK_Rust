...
pub struct DeleteAutomaticCoinsForwardingResponseItem {
...
impl DeleteAutomaticCoinsForwardingResponseItem {
    pub fn new(callback_url: String, confirmations_count: String, created_timestamp: String, fee_priority: FeePriority, from_address: String, minimum_transfer_amount: String, reference_id: String, to_address: String) -> DeleteAutomaticCoinsForwardingResponseItem {
