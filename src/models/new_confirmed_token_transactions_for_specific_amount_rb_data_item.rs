...
pub struct NewConfirmedTokenTransactionsForSpecificAmountRbDataItem {
...
impl NewConfirmedTokenTransactionsForSpecificAmountRbDataItem {
    pub fn new(amount_higher_than: i64, callback_url: String, contract_address: String) -> NewConfirmedTokenTransactionsForSpecificAmountRbDataItem {
