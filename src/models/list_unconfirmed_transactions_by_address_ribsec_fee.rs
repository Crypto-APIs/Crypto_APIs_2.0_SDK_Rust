...
pub struct ListUnconfirmedTransactionsByAddressRibsecFee {
...
impl ListUnconfirmedTransactionsByAddressRibsecFee {
    /// Object representation of the transaction fee
    pub fn new(amount: String, unit: String) -> ListUnconfirmedTransactionsByAddressRibsecFee {
