...
pub struct AddTokensToExistingFromAddressRequestBodyDataItem {
    ...
    pub token_data: Box<crate::models::AddTokensToExistingFromAddressRequestBodyTokenData>,
}

impl AddTokensToExistingFromAddressRequestBodyDataItem {
    pub fn new(callback_url: String, confirmations_count: i32, fee_priority: FeePriority, from_address: String, minimum_transfer_amount: String, to_address: String, token_data: crate::models::AddTokensToExistingFromAddressRequestBodyTokenData) -> AddTokensToExistingFromAddressRequestBodyDataItem {
