...
impl GetBlockDetailsByBlockHashFromCallbackRibsl {
    /// Litecoin
    pub fn new(bits: String, chainwork: String, difficulty: String, merkle_root: String, nonce: i32, size: i32, strippedsize: i32, version: i32, version_hex: String, weight: i32) -> GetBlockDetailsByBlockHashFromCallbackRibsl {
