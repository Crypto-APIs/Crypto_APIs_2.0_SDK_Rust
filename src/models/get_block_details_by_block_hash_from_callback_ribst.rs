...
pub struct GetBlockDetailsByBlockHashFromCallbackRibst {
...
impl GetBlockDetailsByBlockHashFromCallbackRibst {
    /// Tron
    pub fn new(bandwidth_used: String, burned_trx: String, energy_used: String, size: i32) -> GetBlockDetailsByBlockHashFromCallbackRibst {
