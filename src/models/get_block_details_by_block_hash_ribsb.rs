...
impl GetBlockDetailsByBlockHashRibsb {
    /// Bitcoin
    pub fn new(difficulty: String, bits: String, chainwork: String, merkle_root: String, nonce: i64, size: i32, stripped_size: i32, version: i32, version_hex: String, weight: i32) -> GetBlockDetailsByBlockHashRibsb {
