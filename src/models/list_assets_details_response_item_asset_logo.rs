...
pub struct ListAssetsDetailsResponseItemAssetLogo {
...
impl ListAssetsDetailsResponseItemAssetLogo {
    /// Defines the logo of the asset.
    pub fn new(encoding: String, image_data: String, mime_type: String) -> ListAssetsDetailsResponseItemAssetLogo {
