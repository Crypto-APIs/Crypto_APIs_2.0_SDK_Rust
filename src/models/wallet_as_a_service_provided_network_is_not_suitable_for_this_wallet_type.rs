...
pub struct WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType {
...
impl WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType {
    /// wallet_as_a_service_provided_network_is_not_suitable_for_this_wallet_type
    pub fn new(code: String, message: String) -> WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType {
