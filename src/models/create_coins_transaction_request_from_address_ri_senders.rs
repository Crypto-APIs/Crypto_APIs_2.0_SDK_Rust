...
pub struct CreateCoinsTransactionRequestFromAddressRiSenders {
    /// Defines the sender's public address.
    #[serde(rename = "address")]
    pub address: String,
}

impl CreateCoinsTransactionRequestFromAddressRiSenders {
    /// Defines details about the source, i.e. the sender.
    pub fn new(address: String) -> CreateCoinsTransactionRequestFromAddressRiSenders {
