...
pub struct GetWalletTransactionDetailsByTransactionIdribs {
    ...
    pub gas_price: Box<crate::models::GetWalletTransactionDetailsByTransactionIdribspGasPrice>,
...
impl GetWalletTransactionDetailsByTransactionIdribs {
    pub fn new(locktime: i64, size: i32, v_size: i32, version: i32, vin: Vec<crate::models::GetWalletTransactionDetailsByTransactionIdribszVin>, vout: Vec<crate::models::ListTransactionsByBlockHeightRibszVout>, contract: String, gas_limit: String, gas_price: crate::models::GetWalletTransactionDetailsByTransactionIdribspGasPrice, gas_used: String, input_data: String, nonce: i32, transaction_status: String, binding_sig: String, expiry_height: i32, join_split_pub_key: String, join_split_sig: String, overwintered: bool, value_balance: String, version_group_id: String, amount: String, bandwidth_used: String, energy_used: String, has_internal_transactions: bool, has_token_transfers: bool, input: String, status: String) -> GetWalletTransactionDetailsByTransactionIdribs {
