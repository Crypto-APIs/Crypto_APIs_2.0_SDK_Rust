...
pub struct GetAddressBalanceRiConfirmedBalance {
...
impl GetAddressBalanceRiConfirmedBalance {
    pub fn new(amount: String, unit: String) -> GetAddressBalanceRiConfirmedBalance {
