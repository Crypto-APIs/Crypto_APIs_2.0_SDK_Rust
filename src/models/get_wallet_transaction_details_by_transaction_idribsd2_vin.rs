...
pub struct GetWalletTransactionDetailsByTransactionIdribsd2Vin {
...
impl GetWalletTransactionDetailsByTransactionIdribsd2Vin {
    pub fn new(addresses: Vec<String>, script_sig: crate::models::GetTransactionDetailsByTransactionIdribsd2ScriptSig, sequence: i64) -> GetWalletTransactionDetailsByTransactionIdribsd2Vin {
