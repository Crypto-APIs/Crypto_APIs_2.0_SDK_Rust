...
impl GetWalletTransactionDetailsByTransactionIdribsd2Vin {
    pub fn new(addresses: Vec<String>, script_sig: crate::models::GetTransactionDetailsByTransactionIdribsd2ScriptSig, sequence: i32) -> GetWalletTransactionDetailsByTransactionIdribsd2Vin {
