...
pub struct AddressTokensTransactionUnconfirmedEthereumerc20token {
...
impl AddressTokensTransactionUnconfirmedEthereumerc20token {
    /// ethereumERC20Token
    pub fn new(name: String, symbol: String, amount: String, contract_address: String) -> AddressTokensTransactionUnconfirmedEthereumerc20token {
