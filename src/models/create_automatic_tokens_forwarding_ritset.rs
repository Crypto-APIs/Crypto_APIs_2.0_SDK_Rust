...
pub struct CreateAutomaticTokensForwardingRitset {
    /// Represents the specific `contractAddress` of the Token that will be forwarded.
    #[serde(rename = "contractAddress")]
    pub contract_address: String,
}

impl CreateAutomaticTokensForwardingRitset {
    /// Ethereum Token
    pub fn new(contract_address: String) -> CreateAutomaticTokensForwardingRitset {
