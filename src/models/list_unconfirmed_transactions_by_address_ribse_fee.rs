...
pub struct ListUnconfirmedTransactionsByAddressRibseFee {
...
impl ListUnconfirmedTransactionsByAddressRibseFee {
    /// Object representation of the transaction fee
    pub fn new(amount: String, unit: String) -> ListUnconfirmedTransactionsByAddressRibseFee {
