...
pub struct ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin {
...
impl ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin {
    pub fn new(addresses: Vec<String>, script_sig: crate::models::GetTransactionDetailsByTransactionIdResponseItemBlockchainSpecificBitcoinScriptSig, sequence: String, txinwitness: Vec<String>) -> ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin {
