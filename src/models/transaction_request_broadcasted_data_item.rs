...
impl TransactionRequestBroadcastedDataItem {
    ...
    pub fn new(blockchain: String, network: String, required_approvals: i32, required_rejections: i32, current_approvals: i32, current_rejections: i32, transaction_id: String) -> TransactionRequestBroadcastedDataItem {
