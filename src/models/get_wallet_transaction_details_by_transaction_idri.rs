...
impl GetWalletTransactionDetailsByTransactionIdri {
    pub fn new(index: i32, is_confirmed: bool, recipients: String, senders: String, timestamp: i32, transaction_hash: String, transaction_id: String, fee: crate::models::GetWalletTransactionDetailsByTransactionIdriFee, blockchain_specific: crate::models::GetWalletTransactionDetailsByTransactionIdribs) -> GetWalletTransactionDetailsByTransactionIdri {
