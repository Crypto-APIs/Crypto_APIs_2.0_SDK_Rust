...
pub struct NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem {
...
impl NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem {
    pub fn new(address: String, callback_url: String, confirmations_count: i32) -> NewConfirmedCoinsTransactionsAndEachConfirmationRequestBodyDataItem {
