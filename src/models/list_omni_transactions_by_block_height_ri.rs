...
pub struct ListOmniTransactionsByBlockHeightRi {
    ...
    pub recipients: Vec<crate::models::ListOmniTransactionsByBlockHeightRiRecipients>,
    /// Represents an object of addresses that provide the funds.
    #[serde(rename = "senders")]
    pub senders: Vec<crate::models::ListOmniTransactionsByBlockHeightRiSenders>,
    ...
    pub version: i32,
    #[serde(rename = "fee")]
    pub fee: Box<crate::models::ListOmniTransactionsByBlockHeightRiFee>,
}

impl ListOmniTransactionsByBlockHeightRi {
    pub fn new(amount: String, divisible: bool, mined_in_block_hash: String, mined_in_block_height: i32, position_in_block: i32, property_id: i32, recipients: Vec<crate::models::ListOmniTransactionsByBlockHeightRiRecipients>, senders: Vec<crate::models::ListOmniTransactionsByBlockHeightRiSenders>, timestamp: i32, transaction_id: String, _type: String, type_int: i32, valid: bool, version: i32, fee: crate::models::ListOmniTransactionsByBlockHeightRiFee) -> ListOmniTransactionsByBlockHeightRi {
