...
pub struct DeleteAutomaticTokensForwardingRi {
    ...
    pub token_data: Box<crate::models::DeleteAutomaticTokensForwardingRits>,
}

impl DeleteAutomaticTokensForwardingRi {
    pub fn new(callback_url: String, confirmations_count: i32, created_timestamp: i32, fee_address: String, fee_priority: FeePriority, from_address: String, minimum_transfer_amount: String, reference_id: String, to_address: String, token_data: crate::models::DeleteAutomaticTokensForwardingRits) -> DeleteAutomaticTokensForwardingRi {
