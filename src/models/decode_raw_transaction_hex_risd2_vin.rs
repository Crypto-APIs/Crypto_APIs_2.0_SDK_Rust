...
pub struct DecodeRawTransactionHexRisd2Vin {
    ...
    pub script_sig: Box<crate::models::DecodeRawTransactionHexRisd2ScriptSig>,
...
impl DecodeRawTransactionHexRisd2Vin {
    pub fn new(script_sig: crate::models::DecodeRawTransactionHexRisd2ScriptSig) -> DecodeRawTransactionHexRisd2Vin {
