...
pub struct GetEip1559FeeRecommendationsRiMaxFeePerGas {
...
impl GetEip1559FeeRecommendationsRiMaxFeePerGas {
    pub fn new(fast: String, slow: String, standard: String, unit: String) -> GetEip1559FeeRecommendationsRiMaxFeePerGas {
