...
pub struct GetWalletTransactionDetailsByTransactionIdribsb {
    ...
    #[serde(rename = "vin")]
    pub vin: Vec<crate::models::GetWalletTransactionDetailsByTransactionIdribsbVin>,
    /// Represents the transaction outputs.
    #[serde(rename = "vout")]
    pub vout: Vec<crate::models::GetWalletTransactionDetailsByTransactionIdribsbVout>,
}
