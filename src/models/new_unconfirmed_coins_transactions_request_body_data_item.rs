...
pub struct NewUnconfirmedCoinsTransactionsRequestBodyDataItem {
...
impl NewUnconfirmedCoinsTransactionsRequestBodyDataItem {
    pub fn new(address: String, callback_url: String) -> NewUnconfirmedCoinsTransactionsRequestBodyDataItem {
