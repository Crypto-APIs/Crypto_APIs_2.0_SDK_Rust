...
pub struct BlockchainDataAddressEventSubscriptionNotFound {
...
impl BlockchainDataAddressEventSubscriptionNotFound {
    /// blockchain_data_address_event_subscription_not_found
    pub fn new(code: String, message: String) -> BlockchainDataAddressEventSubscriptionNotFound {
