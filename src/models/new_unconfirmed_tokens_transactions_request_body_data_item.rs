...
pub struct NewUnconfirmedTokensTransactionsRequestBodyDataItem {
...
impl NewUnconfirmedTokensTransactionsRequestBodyDataItem {
    pub fn new(address: String, callback_url: String) -> NewUnconfirmedTokensTransactionsRequestBodyDataItem {
