...
pub struct ListUnconfirmedOmniTransactionsByAddressResponseItem {
    ...
    pub senders: Vec<crate::models::ListUnconfirmedOmniTransactionsByAddressResponseItemSenders>,
...
impl ListUnconfirmedOmniTransactionsByAddressResponseItem {
    pub fn new(amount: String, divisible: bool, mined: bool, property_id: i32, recipients: Vec<crate::models::ListOmniTransactionsByAddressResponseItemRecipients>, senders: Vec<crate::models::ListUnconfirmedOmniTransactionsByAddressResponseItemSenders>, sent: bool, timestamp: i32, transaction_id: String, _type: String, type_int: i32, version: i32, fee: crate::models::ListUnconfirmedOmniTransactionsByAddressResponseItemFee) -> ListUnconfirmedOmniTransactionsByAddressResponseItem {
        ListUnconfirmedOmniTransactionsByAddressResponseItem {
            amount,
            divisible,
            mined,
