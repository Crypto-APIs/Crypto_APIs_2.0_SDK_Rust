...
pub struct GetUnconfirmedOmniTransactionByTransactionIdTxidRi {
    ...
    pub recipients: Vec<crate::models::GetUnconfirmedOmniTransactionByTransactionIdTxidRiRecipients>,
    /// Represents an object of addresses that provide the funds.
    #[serde(rename = "senders")]
    pub senders: Vec<crate::models::GetUnconfirmedOmniTransactionByTransactionIdTxidRiSenders>,
...
impl GetUnconfirmedOmniTransactionByTransactionIdTxidRi {
    pub fn new(amount: String, divisible: bool, mined: bool, property_id: i32, recipients: Vec<crate::models::GetUnconfirmedOmniTransactionByTransactionIdTxidRiRecipients>, senders: Vec<crate::models::GetUnconfirmedOmniTransactionByTransactionIdTxidRiSenders>, sent: bool, timestamp: i32, transaction_id: String, _type: String, type_int: i32, version: i32, fee: crate::models::ListUnconfirmedOmniTransactionsByAddressRiFee) -> GetUnconfirmedOmniTransactionByTransactionIdTxidRi {
