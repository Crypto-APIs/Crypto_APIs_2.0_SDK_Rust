...
pub struct ListConfirmedTransactionsByAddressRibszVShieldedSpend {
...
impl ListConfirmedTransactionsByAddressRibszVShieldedSpend {
    pub fn new(anchor: String, cv: String, nullifier: String, proof: String, rk: String, spend_auth_sig: String) -> ListConfirmedTransactionsByAddressRibszVShieldedSpend {
