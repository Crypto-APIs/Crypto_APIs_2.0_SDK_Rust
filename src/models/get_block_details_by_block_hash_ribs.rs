...
impl GetBlockDetailsByBlockHashRibs {
    pub fn new(difficulty: String, bits: String, chainwork: String, merkle_root: String, nonce: String, size: i32, stripped_size: i32, version: i32, version_hex: String, weight: i32, extra_data: String, gas_limit: i32, gas_used: i32, mined_in_seconds: i32, sha3_uncles: String, total_difficulty: String, uncles: Vec<String>, ds_block: i32, ds_difficulty: String, ds_leader: String, micro_blocks: Vec<String>) -> GetBlockDetailsByBlockHashRibs {
