...
pub struct CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRis {
...
impl CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRis {
    /// Represents the specific token data which depends on its type - if it is a Coin or Token.
    pub fn new(contract_address: String, fee_limit: String, symbol: String) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRis {
