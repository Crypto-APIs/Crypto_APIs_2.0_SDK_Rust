...
pub struct GetAssetDetailsByAssetIdriAssetLogo {
...
impl GetAssetDetailsByAssetIdriAssetLogo {
    pub fn new(encoding: String, image_data: String, mime_type: String) -> GetAssetDetailsByAssetIdriAssetLogo {
