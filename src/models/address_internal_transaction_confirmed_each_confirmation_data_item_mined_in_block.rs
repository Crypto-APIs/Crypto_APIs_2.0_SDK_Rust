...
pub struct AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock {
...
impl AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock {
    /// Refers to the specific block the transaction was mined in.
    pub fn new(height: i32, hash: String, timestamp: i32) -> AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock {
