...
impl GetBlockDetailsByBlockHashRibsd2 {
    /// Dash
    pub fn new(difficulty: String, nonce: i32, size: i32, bits: String, chainwork: String, merkle_root: String, version: i32, version_hex: String) -> GetBlockDetailsByBlockHashRibsd2 {
