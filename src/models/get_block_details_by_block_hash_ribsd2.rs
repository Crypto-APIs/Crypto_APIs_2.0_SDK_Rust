...
impl GetBlockDetailsByBlockHashRibsd2 {
    /// Dash
    pub fn new(difficulty: String, bits: String, chainwork: String, merkle_root: String, nonce: String, size: i32, version: i32, version_hex: String) -> GetBlockDetailsByBlockHashRibsd2 {
