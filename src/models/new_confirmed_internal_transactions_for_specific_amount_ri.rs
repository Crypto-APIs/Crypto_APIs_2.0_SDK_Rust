...
pub struct NewConfirmedInternalTransactionsForSpecificAmountRi {
...
impl NewConfirmedInternalTransactionsForSpecificAmountRi {
    pub fn new(amount_higher_than: i64, callback_url: String, created_timestamp: i32, event_type: String, is_active: bool, reference_id: String) -> NewConfirmedInternalTransactionsForSpecificAmountRi {
