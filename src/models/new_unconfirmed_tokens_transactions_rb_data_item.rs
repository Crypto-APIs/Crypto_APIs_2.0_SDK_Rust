...
pub struct NewUnconfirmedTokensTransactionsRbDataItem {
...
impl NewUnconfirmedTokensTransactionsRbDataItem {
    pub fn new(address: String, callback_url: String) -> NewUnconfirmedTokensTransactionsRbDataItem {
