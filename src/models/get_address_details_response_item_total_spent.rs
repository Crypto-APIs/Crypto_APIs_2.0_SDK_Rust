...
pub struct GetAddressDetailsResponseItemTotalSpent {
...
impl GetAddressDetailsResponseItemTotalSpent {
    pub fn new(amount: String, unit: String) -> GetAddressDetailsResponseItemTotalSpent {
