...
pub struct BlockHeightReachedDataItem {
...
impl BlockHeightReachedDataItem {
    /// Defines an `item` as one result.
    pub fn new(blockchain: String, network: String, height: i32, hash: String, timestamp: i32) -> BlockHeightReachedDataItem {
