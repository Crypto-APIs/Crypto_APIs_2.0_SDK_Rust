...
pub struct NewConfirmedCoinsTransactionsRbDataItem {
...
impl NewConfirmedCoinsTransactionsRbDataItem {
    pub fn new(address: String, callback_url: String) -> NewConfirmedCoinsTransactionsRbDataItem {
