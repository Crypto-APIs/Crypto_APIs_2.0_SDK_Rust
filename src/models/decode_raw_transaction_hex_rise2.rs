...
pub struct DecodeRawTransactionHexRise2 {
...
impl DecodeRawTransactionHexRise2 {
    /// Ethereum Classic
    pub fn new(gas_limit: String, nonce: i32, recipient: String, sender: String, _type: i32) -> DecodeRawTransactionHexRise2 {
