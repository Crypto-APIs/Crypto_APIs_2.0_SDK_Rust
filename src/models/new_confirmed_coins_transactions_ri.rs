...
impl NewConfirmedCoinsTransactionsRi {
    pub fn new(address: String, callback_secret_key: String, callback_url: String, created_timestamp: i32, event_type: String, is_active: bool, receive_callback_on: i32, reference_id: String) -> NewConfirmedCoinsTransactionsRi {
