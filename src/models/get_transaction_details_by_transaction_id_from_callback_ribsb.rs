...
impl GetTransactionDetailsByTransactionIdFromCallbackRibsb {
    /// Bitcoin
    pub fn new(locktime: i64, size: i32, v_size: i32, version: i32, vin: Vec<crate::models::GetTransactionDetailsByTransactionIdFromCallbackRibsbVin>, vout: Vec<crate::models::GetTransactionDetailsByTransactionIdribsbVout>) -> GetTransactionDetailsByTransactionIdFromCallbackRibsb {
