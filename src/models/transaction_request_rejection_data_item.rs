...
pub struct TransactionRequestRejectionDataItem {
...
impl TransactionRequestRejectionDataItem {
    /// Defines an `item` as one result.
    pub fn new(blockchain: String, network: String, required_approvals: i32, required_rejections: i32, current_approvals: i32, current_rejections: i32) -> TransactionRequestRejectionDataItem {
