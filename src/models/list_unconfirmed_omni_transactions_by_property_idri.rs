...
pub struct ListUnconfirmedOmniTransactionsByPropertyIdri {
...
impl ListUnconfirmedOmniTransactionsByPropertyIdri {
    pub fn new(amount: String, divisible: bool, mined: bool, property_id: i32, recipients: Vec<crate::models::ListOmniTransactionsByAddressRiRecipients>, senders: Vec<crate::models::GetUnconfirmedOmniTransactionByTransactionIdTxidRiSenders>, sent: bool, timestamp: i32, transaction_id: String, _type: String, type_iint: i32, version: i32, fee: crate::models::ListUnconfirmedOmniTransactionsByAddressRiFee) -> ListUnconfirmedOmniTransactionsByPropertyIdri {
