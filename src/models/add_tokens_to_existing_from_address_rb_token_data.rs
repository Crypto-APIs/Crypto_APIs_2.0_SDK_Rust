...
pub struct AddTokensToExistingFromAddressRbTokenData {
...
impl AddTokensToExistingFromAddressRbTokenData {
    pub fn new(property_id: i32, contract_address: String) -> AddTokensToExistingFromAddressRbTokenData {
