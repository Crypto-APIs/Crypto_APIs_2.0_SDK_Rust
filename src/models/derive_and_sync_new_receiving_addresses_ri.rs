...
pub struct DeriveAndSyncNewReceivingAddressesRi {
...
impl DeriveAndSyncNewReceivingAddressesRi {
    pub fn new(address: String, address_format: String, address_type: AddressType, derivation_type: DerivationType, index: String) -> DeriveAndSyncNewReceivingAddressesRi {
