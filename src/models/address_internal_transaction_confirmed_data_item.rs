...
pub struct AddressInternalTransactionConfirmedDataItem {
...
impl AddressInternalTransactionConfirmedDataItem {
    /// Defines an `item` as one result.
    pub fn new(blockchain: String, network: String, address: String, mined_in_block: crate::models::AddressInternalTransactionConfirmedDataItemMinedInBlock, parent_transaction_id: String, operation_id: String, amount: String, unit: String, direction: Direction) -> AddressInternalTransactionConfirmedDataItem {
