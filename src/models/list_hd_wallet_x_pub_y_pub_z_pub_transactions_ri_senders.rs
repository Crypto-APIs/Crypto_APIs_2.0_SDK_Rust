...
pub struct ListHdWalletXPubYPubZPubTransactionsRiSenders {
...
impl ListHdWalletXPubYPubZPubTransactionsRiSenders {
    pub fn new(address: String, amount: String, is_member: bool) -> ListHdWalletXPubYPubZPubTransactionsRiSenders {
