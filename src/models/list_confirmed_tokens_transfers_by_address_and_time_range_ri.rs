...
impl ListConfirmedTokensTransfersByAddressAndTimeRangeRi {
    pub fn new(contract_address: String, mined_in_block_height: i32, recipient_address: String, sender_address: String, token_decimals: i32, token_name: String, token_symbol: String, token_type: String, transaction_hash: String, transaction_timestamp: i32) -> ListConfirmedTokensTransfersByAddressAndTimeRangeRi {
