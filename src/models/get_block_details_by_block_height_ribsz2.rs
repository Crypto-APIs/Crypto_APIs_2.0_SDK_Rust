...
pub struct GetBlockDetailsByBlockHeightRibsz2 {
...
impl GetBlockDetailsByBlockHeightRibsz2 {
    /// Zilliqa
    pub fn new(difficulty: String, ds_block: i32, ds_difficulty: String, ds_leader: String, gas_limit: i32, gas_used: i32, micro_blocks: Vec<String>) -> GetBlockDetailsByBlockHeightRibsz2 {
