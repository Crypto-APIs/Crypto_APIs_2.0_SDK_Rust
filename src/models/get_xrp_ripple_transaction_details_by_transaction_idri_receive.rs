...
impl GetXrpRippleTransactionDetailsByTransactionIdriReceive {
    /// Defines on object array of the funds for which an offer is made.
    pub fn new(amount: String, unit: String) -> GetXrpRippleTransactionDetailsByTransactionIdriReceive {
