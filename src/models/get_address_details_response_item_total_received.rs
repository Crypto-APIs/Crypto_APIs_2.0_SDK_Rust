...
pub struct GetAddressDetailsResponseItemTotalReceived {
...
impl GetAddressDetailsResponseItemTotalReceived {
    pub fn new(amount: String, unit: String) -> GetAddressDetailsResponseItemTotalReceived {
