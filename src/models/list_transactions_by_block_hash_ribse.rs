...
pub struct ListTransactionsByBlockHashRibse {
...
impl ListTransactionsByBlockHashRibse {
    /// Ethereum
    pub fn new(contract: String, gas_limit: String, gas_price: crate::models::ListTransactionsByBlockHashRibseGasPrice, gas_used: String, input_data: String, nonce: i32, transaction_status: String) -> ListTransactionsByBlockHashRibse {
