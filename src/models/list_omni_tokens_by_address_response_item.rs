...
pub struct ListOmniTokensByAddressResponseItem {
...
impl ListOmniTokensByAddressResponseItem {
    pub fn new(balance: String, frozen: String, name: String, property_id: i32, reserved: String) -> ListOmniTokensByAddressResponseItem {
