...
pub struct NewConfirmedInternalTransactionsForSpecificAmountRbDataItem {
...
impl NewConfirmedInternalTransactionsForSpecificAmountRbDataItem {
    pub fn new(amount_higher_than: i64, callback_url: String) -> NewConfirmedInternalTransactionsForSpecificAmountRbDataItem {
