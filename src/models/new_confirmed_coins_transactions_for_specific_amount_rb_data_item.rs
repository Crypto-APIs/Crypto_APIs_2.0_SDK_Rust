...
pub struct NewConfirmedCoinsTransactionsForSpecificAmountRbDataItem {
...
impl NewConfirmedCoinsTransactionsForSpecificAmountRbDataItem {
    pub fn new(amount_higher_than: i64, callback_url: String) -> NewConfirmedCoinsTransactionsForSpecificAmountRbDataItem {
