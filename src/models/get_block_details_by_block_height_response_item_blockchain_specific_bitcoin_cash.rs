...
impl GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {
    /// Bitcoin Cash
    pub fn new(difficulty: String, nonce: String, size: i32, bits: String, chainwork: String, merkle_root: String, version: i32, version_hex: String) -> GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash {
