...
impl GetWalletTransactionDetailsByTransactionIdribsbc {
    /// Bitcoin Cash
    pub fn new(locktime: i32, size: i32, version: i32, vin: Vec<crate::models::GetWalletTransactionDetailsByTransactionIdribsbcVin>, vout: Vec<crate::models::GetWalletTransactionDetailsByTransactionIdribsbcVout>) -> GetWalletTransactionDetailsByTransactionIdribsbc {
