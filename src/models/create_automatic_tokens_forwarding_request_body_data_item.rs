...
pub struct CreateAutomaticTokensForwardingRequestBodyDataItem {
    ...
    pub token_data: Box<crate::models::CreateAutomaticTokensForwardingRequestBodyTokenData>,
}

impl CreateAutomaticTokensForwardingRequestBodyDataItem {
    pub fn new(callback_url: String, confirmations_count: String, fee_priority: FeePriority, minimum_transfer_amount: String, to_address: String, token_data: crate::models::CreateAutomaticTokensForwardingRequestBodyTokenData) -> CreateAutomaticTokensForwardingRequestBodyDataItem {
