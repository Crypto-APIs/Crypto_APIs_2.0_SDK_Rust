...
pub struct BlockHeightReachedRbDataItem {
...
impl BlockHeightReachedRbDataItem {
    pub fn new(block_height_reached: i64, callback_url: String) -> BlockHeightReachedRbDataItem {
