...
pub struct ListOmniTransactionsByBlockHashRi {
    ...
    pub senders: Vec<crate::models::ListOmniTransactionsByAddressRiSenders>,
    ...
    pub version: i32,
    #[serde(rename = "fee")]
    pub fee: Box<crate::models::ListOmniTransactionsByBlockHashRiFee>,
}

impl ListOmniTransactionsByBlockHashRi {
    pub fn new(amount: String, divisible: bool, mined_in_block_hash: String, mined_in_block_height: i32, position_in_block: i32, property_id: i32, recipients: Vec<crate::models::ListOmniTransactionsByAddressRiRecipients>, senders: Vec<crate::models::ListOmniTransactionsByAddressRiSenders>, timestamp: i32, transaction_id: String, _type: String, type_int: i32, valid: bool, version: i32, fee: crate::models::ListOmniTransactionsByBlockHashRiFee) -> ListOmniTransactionsByBlockHashRi {
