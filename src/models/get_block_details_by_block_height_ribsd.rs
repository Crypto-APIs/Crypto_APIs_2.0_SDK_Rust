...
impl GetBlockDetailsByBlockHeightRibsd {
    /// Dogecoin
    pub fn new(difficulty: String, bits: String, chainwork: String, merkle_root: String, nonce: String, size: i32, stripped_size: i32, version: i32, weight: i32) -> GetBlockDetailsByBlockHeightRibsd {
