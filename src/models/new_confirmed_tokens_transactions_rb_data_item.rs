...
pub struct NewConfirmedTokensTransactionsRbDataItem {
...
impl NewConfirmedTokensTransactionsRbDataItem {
    pub fn new(address: String, callback_url: String) -> NewConfirmedTokensTransactionsRbDataItem {
