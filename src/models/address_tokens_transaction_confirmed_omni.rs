...
pub struct AddressTokensTransactionConfirmedOmni {
...
impl AddressTokensTransactionConfirmedOmni {
    /// OMNI
    pub fn new(name: String, property_id: String, transaction_type: String, created_by_transaction_id: String, amount: String) -> AddressTokensTransactionConfirmedOmni {
