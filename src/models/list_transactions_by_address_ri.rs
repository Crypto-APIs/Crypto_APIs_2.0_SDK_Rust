...
pub struct ListTransactionsByAddressRi {
    ...
    pub blockchain_specific: Box<crate::models::ListTransactionsByAddressRibs>,
}

impl ListTransactionsByAddressRi {
    pub fn new(index: i32, recipients: Vec<crate::models::GetTransactionDetailsByTransactionIdriRecipients>, senders: Vec<crate::models::GetTransactionDetailsByTransactionIdriSenders>, timestamp: i32, transaction_hash: String, transaction_id: String, fee: crate::models::GetTransactionDetailsByTransactionIdriFee, blockchain_specific: crate::models::ListTransactionsByAddressRibs) -> ListTransactionsByAddressRi {
