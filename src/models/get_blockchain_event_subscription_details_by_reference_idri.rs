...
pub struct GetBlockchainEventSubscriptionDetailsByReferenceIdri {
...
impl GetBlockchainEventSubscriptionDetailsByReferenceIdri {
    pub fn new(blockchain: String, callback_url: String, created_timestamp: i32, event_type: String, is_active: bool, network: String, reference_id: String) -> GetBlockchainEventSubscriptionDetailsByReferenceIdri {
