...
**timestamp** | **i32** | Defines the exact date/time when this block was mined in Unix | 
**transactions_count** | **i32** | Represents the total number of all transactions as part of this block. | 
**blockchain_specific** | [**crate::models::GetBlockDetailsByBlockHeightRibs**](GetBlockDetailsByBlockHeightRIBS.md) |  | 
