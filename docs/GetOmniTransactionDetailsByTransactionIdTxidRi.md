...
**senders** | [**Vec<crate::models::GetOmniTransactionDetailsByTransactionIdTxidRiSenders>**](GetOmniTransactionDetailsByTransactionIDTxidRI_senders.md) | Represents an object of addresses that provide the funds. | 
